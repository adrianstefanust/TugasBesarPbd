...
INSERT INTO `admin` VALUES (1,'admin1','admin1','Adrian Stefanus'),(2,'admin2','admin2','Hengky Surya'),(3,'admin3','admin1','Stephen Senjaya');
...
INSERT INTO `hubungancustomer` VALUES (1,388,11,12,'2018-05-15 18:26:01',1,NULL),(2,388,11,7,'2018-05-15 18:26:11',0,12),(3,15,26,1,'2018-05-16 18:36:58',1,NULL);
...
INSERT INTO `perubahancustomer` VALUES (1,5,'nilaiInvestasi','99999999',NULL,'1','2018-05-16 19:39:01',1,0),(2,5,'nilaiInvestasi','1',1,'2','2018-05-16 19:39:06',1,0),(3,5,'nilaiInvestasi','2',2,'5','2018-05-16 19:39:13',1,0),(4,4,'nilaiInvestasi','13434991',NULL,'13434999','2018-05-16 19:41:13',3,0),(5,4,'nilaiInvestasi','13434999',4,'13435000','2018-05-16 19:41:22',3,0),(6,267,'nilaiInvestasi','51397531',NULL,'100000000','2018-05-16 19:58:48',1,0),(7,267,'nilaiInvestasi','100000000',6,'100000001','2018-05-16 20:00:42',1,0),(8,5,'nilaiInvestasi','5',3,'200000000','2018-05-16 20:01:51',1,0),(9,121,'nilaiInvestasi','30000',NULL,'30000000','2018-05-16 20:31:50',1,0);
...
/*!50003 DROP PROCEDURE IF EXISTS `CustomerInvestasiTerbesar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `JumlahCustomerAntarDaerah` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `JumlahInvestasiAntarDaerah` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `JumlahInvestasiAntarDaerah`(
in daerah1 int,
in daerah2 int
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LogPerubahanCustomer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RataRataInvestasiAntarDaerah` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RataRataInvestasiAntarDaerah`(
in daerah1 int,
in daerah2 int
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RataRataUmurAntarDaerah` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2018-05-16 21:35:21
