                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Insert Data Customer</li>
                        </ol>
                    </div>
                </div>
            </div>
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Insert Data Customer</strong>
                        </div>
                        <div class="card-body">
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                              <div class="card-body">
                                  ...
                                  <hr>
                                  <form action="./insertCustomer" method="post" novalidate="novalidate">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input id="tanggal_lahir" name="tanggal_lahir" type="date" class="form-control" value="">
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input id="nilai_invest" name="nilai_invest" type="number" class="form-control" value="">
                                      </div>
                                      <div>
